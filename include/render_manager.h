 ...
 * @param layer The ID of the scene where the texture is drawn (0 background, 1 middle, 2 foreground).
 * @param sublayer The sublayer to draw the texture, lower sublayer gets drawn first (0->1->2) if two texute have the same sublayer but overlap, the first to be drawn is based on the ID the texute gets.
 ...
 * @param layer The ID of the scene where the texture is drawn (1 background, 2 middle, 3 foreground).
 * @param sublayer The sublayer to draw the surface, lower sublayer gets drawn first (0->1->2) if two surface have the same sublayer but overlap, the first to be drawn is based on the ID the texute gets.
 ...
 * @return itemID > 0 if success, 0 if failure.
 */
// int render_managerAddSurfaceToDraw(int layer, signed int sublayer, SDL_Surface *surfacePtr, const int x, const int y);
 ...
 * @param layer search inside one scene, if -1, search across all scenes.
